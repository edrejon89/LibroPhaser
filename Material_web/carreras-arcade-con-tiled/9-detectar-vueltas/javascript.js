class Escena extends Phaser.Scene {
  ...
  preload() {
    //this.load.baseURL = '/curso/phaser/ex/acierta-imagen/img/';
    resize();
  ...
  create() {
    ...
    this.players = [];
    this.n_jugadores = 4;
    this.playersGroup = this.physics.add.group(this);

    this.creaPlayers();

    this.physics.add.collider(this.playersGroup, this.playersGroup);
    this.physics.add.collider(this.playersGroup, backgroundLayer);
